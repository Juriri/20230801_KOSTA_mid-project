				        ...
				        <% for (int col = 0; col < 7; col++) { %>
				            ...
				            <% } else { %>
	                            ...
	                            <td class="<%= todayClass %>">
	                                ...
	                                onclick="location.href='/calendar/Insert?selectedDate=<%= new java.text.SimpleDateFormat("yyyy-MM-dd").format(java.sql.Date.valueOf(LocalDate.of(currentYear, currentMonth, dayOfMonth))) %>'"><%= dayOfMonth %>
	                                </button>
	                            </td>
